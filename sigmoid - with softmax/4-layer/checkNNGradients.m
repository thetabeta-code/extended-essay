...
Theta4 = debugInitializeWeights(hidden_layer_4_size, hidden_layer_3_size);
Theta5 = debugInitializeWeights(num_labels, hidden_layer_4_size);
...
costFunc = @(p) costFunction4layer(p, input_layer_size, hidden_layer_1_size, ...
                               hidden_layer_2_size, hidden_layer_3_size, hidden_layer_4_size, num_labels, X, y, lambda);
