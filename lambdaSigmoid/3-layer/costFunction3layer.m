function [J grad] = costFunction3layer(nn_params, ...
                                   input_layer_size, ...
                                   hidden_layer_1_size, ...
                                   hidden_layer_2_size, ...
                                   hidden_layer_3_size, ...
...
regularization = lambda/(2*m) * (Theta_one_square_sum + Theta_two_square_sum + Theta_three_square_sum + Theta_four_square_sum);

J = J + regularization;
% ================================== Backpropagation ============================================
DELTA5 = A5 .- y_encoded';
DELTA4 = (DELTA5 * (Theta4(:, 2:end))) .* ReLUGradient(Z4);
DELTA3 = (DELTA4 * (Theta3(:, 2:end))) .* ReLUGradient(Z3);
