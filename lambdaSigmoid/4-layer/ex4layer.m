function cv_accuracy = ex4layer(trainX, trainY, cvX, cvY,...
...
cd "D:/Oakridge/DP-1/Extended_essay/Dataset/lambdaSigmoid/4-layer";
...
predCV = predict4layer(Theta1, Theta2, Theta3, Theta4, Theta5, cvX);
