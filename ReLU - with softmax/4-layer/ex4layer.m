...
cd "D:/Oakridge/DP-1/Extended_essay/Dataset/ReLU - with softmax/4-layer";
...
csvwrite(strcat('ReLU_L4N', int2str(hidden_layer_size), 'I', int2str(maxIter), '_R', int2str(iteration), '.dat'), newcostvals);
csvwrite(strcat('ReLU_L4N', int2str(hidden_layer_size), 'I', int2str(maxIter), '_R', int2str(iteration), '_acc.dat'), final_accuracy);
csvwrite(strcat('ReLU_L4N', int2str(hidden_layer_size), 'I', int2str(maxIter), '_R', int2str(iteration), '_testacc.dat'), test_accuracy);

save(strcat('ReLU_L4N', int2str(hidden_layer_size), 'I', int2str(maxIter), '_R', int2str(iteration), 'Theta1.mat'), 'Theta1');
save(strcat('ReLU_L4N', int2str(hidden_layer_size), 'I', int2str(maxIter), '_R', int2str(iteration), 'Theta2.mat'), 'Theta2');
save(strcat('ReLU_L4N', int2str(hidden_layer_size), 'I', int2str(maxIter), '_R', int2str(iteration), 'Theta3.mat'), 'Theta3');
save(strcat('ReLU_L4N', int2str(hidden_layer_size), 'I', int2str(maxIter), '_R', int2str(iteration), 'Theta4.mat'), 'Theta4');
save(strcat('ReLU_L4N', int2str(hidden_layer_size), 'I', int2str(maxIter), '_R', int2str(iteration), 'Theta5.mat'), 'Theta5');
