...
lambVec = [0.009 0.01 0.015 0.02 0.03 0.05 0.07 0.09];
...
if(num_layers == 1)
  addpath("D:/Oakridge/DP-1/Extended_essay/Dataset/lambdaReLU/1-layer");
...
elseif(num_layers == 2)
  addpath("D:/Oakridge/DP-1/Extended_essay/Dataset/lambdaReLU/2-layer");
  initial_Theta1 = randInitializeWeights(input_layer_size, hidden_layer_size);
  ...
  fprintf("Best lambda for %f layers %f hidden neurons = %f\n", num_layers, hidden_layer_size, lambVec(bestLambda));
elseif(num_layers == 3)
  addpath("D:/Oakridge/DP-1/Extended_essay/Dataset/lambdaReLU/3-layer");
  initial_Theta1 = randInitializeWeights(input_layer_size, hidden_layer_size);
  initial_Theta2 = randInitializeWeights(hidden_layer_size, hidden_layer_size);
  ...
  fprintf("Best lambda for %f layers %f hidden neurons = %f\n", num_layers, hidden_layer_size, lambVec(bestLambda));
elseif(num_layers == 4)
  addpath("D:/Oakridge/DP-1/Extended_essay/Dataset/lambdaReLU/4-layer");
  initial_Theta1 = randInitializeWeights(input_layer_size, hidden_layer_size);
  initial_Theta2 = randInitializeWeights(hidden_layer_size, hidden_layer_size);
  initial_Theta3 = randInitializeWeights(hidden_layer_size, hidden_layer_size);
...
save(strcat("ReLU_L", int2str(num_layers), "N", int2str(hidden_layer_size), "I", int2str(maxIter), "bestlambda.dat"), 'output');
